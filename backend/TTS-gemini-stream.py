...
def stream_audio(audio_data: bytes, mime_type: str):
  params = parse_audio_mime_type(mime_type)
  sample_rate = params["rate"]
  bits_per_sample = params["bits_per_sample"]
  num_channels = 1
  format_map = {8: pyaudio.paInt8, 16: pyaudio.paInt16, 24: pyaudio.paInt24}

  p = pyaudio.PyAudio()
  stream = p.open(format=format_map[bits_per_sample],
  ...
  for chunk in client.models.generate_content_stream(
    ...
    if (
      ...
      if part.inline_data and part.inline_data.data:
        ...
        stream_audio(audio_data, mime_type)
      elif chunk.text:
        print(chunk.text)
